...
public class MySQLDbmsSyntaxTest extends AbstractDbmsSyntax {

	static final String DRIVER = "com.mysql.jdbc.Driver";
	static final String DB_HOST = "192.168.205.128";
	static final String DB_URL = "jdbc:mysql://192.168.205.128/mysql";
