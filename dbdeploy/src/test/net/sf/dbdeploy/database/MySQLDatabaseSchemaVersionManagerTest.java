...
public class MySQLDatabaseSchemaVersionManagerTest extends AbstractDatabaseSchemaVersionManager {

	static final String CONNECTION_STRING = "jdbc:mysql://192.168.205.128/mysql";
	static final String USERNAME = "dbdeploy_db";
	static final String PASSWORD = "dbdeploy_db";
	static final String DELTA_SET = "All";
	static final String CHANGELOG_TABLE_DOES_NOT_EXIST_MESSAGE = "Could not retrieve change log from database because: Table 'mysql.changelog' doesn't exist";
